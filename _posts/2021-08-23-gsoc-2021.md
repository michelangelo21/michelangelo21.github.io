...
My GSoC experience started smoothly. I was ahead of schedule, and it seemed that MuZero would solve tic tac toe two weeks before the first evaluation period. But I underestimated the difficulty of debugging the reinforcement learning system. Andy Jones' phrase “you might have a few hundred lines of code that you think are correct in an hour, and a system that's actually correct two months later” accurately describes my experience, as I spent most of GSoC finding bugs and tuning hyper params. These two things are closely related in reinforcement learning, and you never know if your system’s poor performances are due to one of the hyperparameters being way off or to a bug in the code.
